...
#     file.write("jon si jhonny") # -> ketimpa

# with open("data_1.txt",'w',encoding="utf-8") as file:
#     file.write("ucup surucup") # -> ketimpa

# with open("data_1.txt",'w',encoding="utf-8") as file:
#     file.write("overwrite") # -> dijalankan

# # 2. mode append -> jika "a" terus, itu akan menambahkan file/kata yang baru tanpa menghapus yang sebelumnya
# # dan "w" itu sebagai pembatas si "a"
...
with open("data_3.txt",'w',encoding="utf-8") as file:
    file.write("data ke 3 \n") # jika file tidak ada, file baru akan dibuat, jika file lama sudah ada, file lama akan dihapus
...
with open("data_3.txt",'r+',encoding="utf-8") as file:
    file.write("otongaswd") # menimpa isi text sesuai dengan panjang data
